...
4. **Intent-Based Interaction & Prompt Resilience:** Differentiates between read-only analysis ("Ask") and code generation ("Edit") using a unified system prompt combined with XML micro-anchoring (`<user_prompt mode="...">`). Tool schemas are intentionally "de-weaponized" into text formatting rules to bypass aggressive RLHF native function-calling triggers, ensuring reliable text extraction and preserving Chain of Thought.
