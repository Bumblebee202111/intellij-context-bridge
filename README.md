...
5. **Slash Commands:** Provides modern macro workflows (e.g., `/plan`, `/review`) via Markdown frontmatter files. Supports stacked invocations and argument interpolation to keep the prompt UI clean while dynamically combining complex behaviors via XML wrapping (WIP).
