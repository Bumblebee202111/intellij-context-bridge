...
4. **Intent-Based Interaction:** Differentiates between read-only analysis ("Ask") and code generation ("Edit") using a unified system prompt combined with XML micro-anchoring (`<user_prompt mode="...">`) to ensure strict LLM adherence to XML tool schemas.
