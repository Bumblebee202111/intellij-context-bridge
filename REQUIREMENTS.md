...
* *Command Design Constraints:* Command definitions MUST utilize dense, direct instructions rather than verbose conversational padding, optimizing for 2026 frontier model comprehension and token efficiency. Review prompts MUST employ targeted lenses (e.g., bugs, simplification, architecture) and explicit constraints (e.g., "Focus only on issues") to combat AI slop and dogmatic responses.
